            ...
            <img
              src={
                props.white
                  ...
                  "/images/header/search-icon-white.png"
                  : process.env.PUBLIC_URL +
                  "/images/header/search-icon.png"
              }
              alt="Search icon"
            />
          </a>
              ...
              <span className="menu-icon -wishlist">
                <img
                  src={
                    props.white
                      ? process.env.PUBLIC_URL +
                      "/images/header/wishlist-icon-white.png"
                      : process.env.PUBLIC_URL +
                      "/images/header/wishlist-icon.png"
                  }
                  alt="Wishlist icon"
                />
              </span>
              ...
              >
                <img
                  src={
                    props.white
                      ? process.env.PUBLIC_URL +
                      "/images/header/cart-icon-white.png"
                      : process.env.PUBLIC_URL +
                      "/images/header/cart-icon.png"
                  }
                  alt="Cart icon"
                />
